...
IF OBJECT_ID('dbo.FinancialTasks', 'U') IS NOT NULL
    DROP TABLE FinancialEngineeringDB.dbo.FinancialTasks;
GO

CREATE TABLE FinancialEngineeringDB.dbo.FinancialTasks (
...
INSERT INTO FinancialEngineeringDB.dbo.FinancialTasks 
